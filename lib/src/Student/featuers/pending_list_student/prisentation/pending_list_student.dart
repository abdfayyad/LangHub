...
import 'package:lang_hub/src/Student/featuers/pending_list_student/prisentation/bloc/cubit.dart';
...
class PendingListStudent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(create: (BuildContext context)=>PendingListStudentCubit(),
