...
class _EditProfileStudentState extends State<EditProfileStudent> {
  ...
  void initState() {
      ...
      _controllerName.text = "${widget.profileStudentModel?.student!.firstName!}" +
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      body: widget.profileStudentModel?.student== null ? Center(
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              TextButton(
                                                  onPressed: () {
                                                    ProfileStudentCubit
                                                        .get(context).changePasswordStudent(_controllerOldPassword.text, _controllerNewPassword.text);
